...
import fr.uha.ensisa.gl.lift.soft.model.Bouchons.Bouchon;
import fr.uha.ensisa.gl.lift.soft.model.Bouchons.ButtonBouchon;
import fr.uha.ensisa.gl.lift.soft.model.Bouchons.DoorBouchon;
import fr.uha.ensisa.gl.lift.soft.model.Bouchons.FloorSensorBouchon;
import fr.uha.ensisa.gl.lift.soft.model.Bouchons.MotorBouchon;
import fr.uha.ensisa.gl.lift.soft.model.Bouchons.TimerBouchon;
import fr.uha.ensisa.gl.lift.soft.model.Enumerations.Messages;
import fr.uha.ensisa.gl.lift.soft.model.Enumerations.MotorStatus;
import fr.uha.ensisa.gl.lift.soft.model.InstancesDeclaration.Actor;
import fr.uha.ensisa.gl.lift.soft.model.InstancesDeclaration.ElevatorController;
import fr.uha.ensisa.gl.lift.soft.model.InstancesDeclaration.Floor;
...
public class AdapterImpl implements AdapterInterface {
	...
	private Bouchon getObjectFromActor(Actor sender)	{
		...
		if (sender == fr.uha.ensisa.gl.lift.soft.model.ElevatorController.InstancesDefinition.Actor.cb0)
			actor = (Bouchon) this.cb0;
		if (sender == fr.uha.ensisa.gl.lift.soft.model.ElevatorController.InstancesDefinition.Actor.fb0)
			actor = (Bouchon) this.fb0;
		if (sender == fr.uha.ensisa.gl.lift.soft.model.ElevatorController.InstancesDefinition.Actor.cb1)
			actor = (Bouchon) this.cb1;
		if (sender == fr.uha.ensisa.gl.lift.soft.model.ElevatorController.InstancesDefinition.Actor.fb1)
			actor = (Bouchon) this.fb1;
		if (sender == fr.uha.ensisa.gl.lift.soft.model.ElevatorController.InstancesDefinition.Actor.cb2)
			actor = (Bouchon) this.cb2;
		if (sender == fr.uha.ensisa.gl.lift.soft.model.ElevatorController.InstancesDefinition.Actor.fb2)
			actor = (Bouchon) this.fb2;
		if (sender == fr.uha.ensisa.gl.lift.soft.model.ElevatorController.InstancesDefinition.Actor.motor)
			actor = (Bouchon) this.motor;
		if (sender == fr.uha.ensisa.gl.lift.soft.model.ElevatorController.InstancesDefinition.Actor.clock)
			actor = (Bouchon) this.timer;
		if (sender == fr.uha.ensisa.gl.lift.soft.model.ElevatorController.InstancesDefinition.Actor.door)
	...
	private int getFloorNumber(Floor floor)	{
		int floorNum = -1;
		if (floor == fr.uha.ensisa.gl.lift.soft.model.ElevatorController.InstancesDefinition.Floor._0)
			floorNum = 0;
		if (floor == fr.uha.ensisa.gl.lift.soft.model.ElevatorController.InstancesDefinition.Floor._1)
			floorNum = 1;
		if (floor == fr.uha.ensisa.gl.lift.soft.model.ElevatorController.InstancesDefinition.Floor._2)
			floorNum = 2;
		return floorNum;
	}
